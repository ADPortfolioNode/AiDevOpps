      ...
      <div className="relative w-full max-w-lg rounded-lg border border-zinc-700 bg-zinc-900 p-6 text-white shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <button type="submit" disabled={isLoading} className="ml-auto inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-zinc-900 disabled:opacity-50 disabled:cursor-not-allowed">
